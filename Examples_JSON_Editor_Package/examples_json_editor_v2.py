...
# -*- coding: utf-8 -*-
"""
Examples JSON Editor (v2 - patched)
-----------------------------------
- GUI-Editor für examples.json
- Felder: file, name, optional image, runtime (python|micropython)
- Behoben: „Bild wählen…“ stürzt nicht mehr ab (Dateityp-Filter korrigiert)
...
APP_TITLE = "Examples JSON Editor (v2)"
...
class ExamplesEditor(tk.Tk):
    ...
    def _build_list(self):
        ...
        self.tree = ttk.Treeview(self.frmList,
                                 columns=("name", "runtime", "file", "image"),
    ...
    def _layout(self):
        ...
        self.rbMP.grid(row=0, column=1); r += 1
