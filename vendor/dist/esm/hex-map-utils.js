 ...
 */
export function getUint64(intelHexMap, address) {
 ...
 */
export function getUint32(intelHexMap, address) {
 ...
 */
export function getUint16(intelHexMap, address) {
 ...
 * @returns Number with the unsigned integer representation of those 2 bytes.
 */
export function getUint8(intelHexMap, address) {
 ...
 */
export function getString(intelHexMap, address) {
...
//# sourceMappingURL=hex-map-utils.js.map