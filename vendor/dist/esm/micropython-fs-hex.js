...
import { createMpFsBuilderCache, generateHexWithFiles, addIntelHexFiles, calculateFileSize, getIntelHexFiles, } from './micropython-fs-builder.js';
 ...
 */
export var microbitBoardId = microbitUh.microbitBoardId;
/**
 * Manage filesystem files in one or multiple MicroPython hex files.
 *
 * @public
 */
export class MicropythonFsHex {
    /**
